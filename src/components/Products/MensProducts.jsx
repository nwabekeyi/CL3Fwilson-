...
function MensProducts({ home = false }) {
  ...
  const products = [
    {
      ...
      price: 15000, // Base price in NGN
      imagePath:
        "https://images.unsplash.com/photo-1593032465170-8adf1100b39c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      department: "Men",
      category: "Suits",
      ...
      variants: [
        ...
        },
        {
          ...
          price: 15500,
          imagePath:
            "https://images.unsplash.com/photo-1594938298603-3b7e935c26fe?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        },
      ],
    },
    {
      ...
      price: 3500,
      imagePath:
        "https://images.unsplash.com/photo-1603251578711-3a6ea8f0e5d5?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      department: "Men",
      category: "Shirts",
    ...
    },
    {
      ...
      price: 8000,
      imagePath:
        "https://images.unsplash.com/photo-1549294413-44f6d0ab4e7d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      department: "Men",
      category: "Footwear",
      ...
      variants: [
        ...
        },
        {
          ...
          price: 8500,
          imagePath:
            "https://images.unsplash.com/photo-1512372802706-2c5a445d3f88?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        },
      ],
    },
    {
      ...
      variants: [
        ...
        },
        {
          ...
          price: 5200,
          imagePath:
            "https://images.unsplash.com/photo-1595435282698-7f12c7c32b45?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        },
      ],
    },
    {
      ...
      price: 2500,
      imagePath:
        "https://images.unsplash.com/photo-1519235106711-6e91e4ea8a1e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      department: "Men",
      ...
      variants: [
        ...
        },
        {
          ...
          price: 2600,
          imagePath:
            "https://images.unsplash.com/photo-1551489187-140f97a317eb?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        },
      ],
    },
    {
      ...
      price: 6000,
      imagePath:
        "https://images.unsplash.com/photo-1601333147855-1066d7d3d3f3?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      department: "Men",
      category: "Jackets",
      ...
      variants: [
        ...
        },
        {
          ...
          price: 6300,
          imagePath:
            "https://images.unsplash.com/photo-1516824467205-afa656d31a79?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        },
      ],
    },
  ];
  ...
  const displayedProducts = home ? products.slice(0, 9) : products;
